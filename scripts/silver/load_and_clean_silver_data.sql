...
CREATE PROCEDURE sp_load_silver_tables()
BEGIN
    /* -------------------------------------------------------------
       Disable FK checks so TRUNCATE and INSERT work even when
       tables are linked with FOREIGN KEY constraints
    ------------------------------------------------------------- */
